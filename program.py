...
def remover_flor():
  ...
  if certeza.upper() == "S":
    ...
    url = "https://de803d02-a6b4-4787-a6fd-b46f77cb2a28-00-17knqdp4e66mp.picard.replit.dev:3000/flores/%s"%id_remover
...
def atualizar_flor():
  ...
  if id_achado:
    dados = {"id":id_desejado,
       ...
       "data":data,
       "especie":especie} 
    url = "https://de803d02-a6b4-4787-a6fd-b46f77cb2a28-00-17knqdp4e66mp.picard.replit.dev:3000/flores/%s"%id_desejado
